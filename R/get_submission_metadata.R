...
get_submissions_metadata <- function(state_filter = "SUBMITTED_WAITING_FOR_REVIEW", group) {
  body <- glue::glue('{{"filterByState":["{state_filter}"],"groupId":"{group}"}}')
  jsonfile <- synRestPOST(
